...
const base =
  ...
  "transition-[transform,border-color,background-color,color,box-shadow] duration-200 ease-out " +
  "hover:-translate-y-px hover:border-brand focus-visible:-translate-y-px motion-reduce:hover:translate-y-0";

const variants = {
  default: "text-ink bg-card hover:bg-wash",
  primary:
    "border-ink bg-ink text-bg hover:bg-brand hover:border-brand",
} as const;
